export const translations = {
  fr: {
    ...
    variation: 'Variation',
    variationNotComputable: 'non calculable : mois A à 0 €',
    ...
    periodGrowthNotComputable: 'non calculable : premier mois à 0 € ou moins',
    overLast: 'Sur les',
  ...
  en: {
    ...
    variation: 'Variation',
    variationNotComputable: 'cannot be computed: month A at €0',

    // Trends
    evolutionOver: 'Evolution over',
    noDataAvailable: 'No data available for this period',
    periodGrowth: 'Growth over period',
    periodGrowthNotComputable: 'cannot be computed: first month at €0 or below',
