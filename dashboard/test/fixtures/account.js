  ...
  byProject: {
    '2026-09': [
      { projectId: 'project-production', projectName: 'Production',
        total: 610.4, detailsCount: 30 },
      { projectId: 'project-staging', projectName: 'Staging',
        total: 220, detailsCount: 11 },
    ],
    '2026-08': [
      { projectId: 'project-production', projectName: 'Production',
        total: 512, detailsCount: 26 },
      { projectId: 'project-staging', projectName: 'Staging',
        total: 190, detailsCount: 9 },
    ],
    '2026-07': [
      { projectId: 'project-production', projectName: 'Production',
        total: 680, detailsCount: 23 },
    ],
  },

  byResourceType: {
    '2026-09': [
      { name: 'Public Cloud', resource_type: 'cloud_project', color: '#3b82f6',
        value: 830.4, detailsCount: 41, serviceCount: 2 },
      { name: 'Dedicated Servers', resource_type: 'dedicated_server', color: '#ef4444',
        value: 270, detailsCount: 1, serviceCount: 1 },
      { name: 'Backup', resource_type: 'backup', color: '#059669',
        value: 90, detailsCount: 3, serviceCount: 3 },
      { name: 'Domains', resource_type: 'domain', color: '#8b5cf6',
        value: 35, detailsCount: 4, serviceCount: 2 },
      { name: 'Licenses', resource_type: 'license', color: '#0891b2',
        value: 25, detailsCount: 1, serviceCount: 1 },
    ],
    '2026-08': [
      { name: 'Public Cloud', resource_type: 'cloud_project', color: '#3b82f6',
        value: 702, detailsCount: 35, serviceCount: 2 },
      { name: 'Dedicated Servers', resource_type: 'dedicated_server', color: '#ef4444',
        value: 270, detailsCount: 1, serviceCount: 1 },
      { name: 'Backup', resource_type: 'backup', color: '#059669',
        value: 40, detailsCount: 2, serviceCount: 2 },
      { name: 'Domains', resource_type: 'domain', color: '#8b5cf6',
        value: 30, detailsCount: 2, serviceCount: 2 },
    ],
    '2026-07': [
      { name: 'Public Cloud', resource_type: 'cloud_project', color: '#3b82f6',
        value: 680, detailsCount: 23, serviceCount: 1 },
      { name: 'Dedicated Servers', resource_type: 'dedicated_server', color: '#ef4444',
        value: 270, detailsCount: 1, serviceCount: 1 },
      { name: 'Domains', resource_type: 'domain', color: '#8b5cf6',
        value: 30, detailsCount: 1, serviceCount: 1 },
    ],
  },
